...
public record VotingCategory(String id, String name, String description, String type, int limit, Optional<List<String>> prohibitons) {
    public static final Codec<VotingCategory> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        Codec.list(Codec.STRING).optionalFieldOf("prohibitons").forGetter(VotingCategory::prohibitons)
